...
return array(
    ...
    'help' => array(
        'undeployable'   => 'Ces articles ne peuvent être attribués à personne.',
        'deployable'   => 'Ces articles peuvent être extraits. Une fois qu\'ils sont assignés, ils supposeront un statut méta de <i class="fa fa-circle text-blue"></i> <strong>Deployed</strong>.',
        'archived'   => 'Ces éléments ne peuvent pas être extraits et ne s\'afficheront que dans la vue Archivée. Ceci est utile pour conserver des informations sur les articles à des fins budgétaires / historiques, mais les garder hors de la liste des articles au jour le jour.',
        'pending'   => 'Ces articles ne peuvent pas encore être attribués à qui que ce soit, souvent utilisés pour des articles en réparation, mais qui devraient revenir à la circulation.',
    ),
