...
return array(
    ...
    'asset_ids'					=> 'ID de l\'article',
    'audit_interval'            => 'Intervalle d\'audit',
    'audit_interval_help'       => 'Si vous devez régulièrement vérifier physiquement vos articles, entrez l\'intervalle en mois.',
    'audit_warning_days'        => 'Seuil d\'avertissement d\'audit',
    'audit_warning_days_help'   => 'Combien de jours à l\'avance devrions-nous vous avertir lorsque les articles doivent être vérifiés?',
    'auto_increment_assets'		=> 'Générer des identifiants d\'articles auto-incrémentés',
    'auto_increment_prefix'		=> 'Préfixe (optionnel)',
    'auto_incrementing_help'    => 'Activer l\'auto-incrémentation des ID d\'article avant de sélectionner cette option',
    'backups'					=> 'Sauvegardes',
    ...
    'default_eula_help_text'	=> 'Vous pouvez également associer les licences d\'utilisations personnalisés à des catégories spécifiques d\'articles .',
    'display_asset_name'        => 'Afficher le nom des articles',
    ...
    'logo_print_assets_help'    => 'Utiliser la marque dans les listes imprimables des articles ',
    ...
    'show_archived_in_list'     => 'Articles archivés',
    'show_archived_in_list_text'     => 'Afficher les articles archivés dans la liste "Tous les articles"',
    'show_assigned_assets'      => 'Afficher les matériels assignés aux matériels',
    'show_assigned_assets_help' => 'Afficher les articles qui ont été assignés aux autres articles dans Voir utilisateurs -> Matériels, Voir Utilisateur -> Info -> Imprimer Tous les matériels assignés et présent dans le compte -> Voir les matériels assignés.',
    ...
    'require_accept_signature_help_text'      => 'L\'activation de cette fonctionnalité nécessite que les utilisateurs signent physiquement l\'acceptation de cet article.',
    'left'        => 'gauche',
    'right'        => 'droite',
    'top'        => 'haut',
    'bottom'        => 'bas',
    ...
    'unique_serial_help_text'                => 'Cocher cette case forcera une contrainte d\'unicité sur les identifiants d\'article',
