...
return array(
    ...
    'assoc_users'	 => 'Ce modèle est actuellement associé à au moins un article et ne peut pas être supprimé. Veuillez supprimer les articles associés et essayer à nouveau. ',


    'create' => array(
        'error'   => 'Le modèle n\'a pas été créé, veuillez essayer à nouveau.',
        'success' => 'Le modèle a été créé avec succès.',
        'duplicate_set' => 'Un modèle d\'article avec ce nom, fabricant et modèle existe déjà.',
    ),
    ...
    'delete' => array(
        'confirm'   => 'Êtes-vous sûr de vouloir supprimer ce modèle d\'article ?',
    ...
    'restore' => array(
        'error'   		=> 'Le modèle d\'article n\'a pas été restauré, veuillez réessayer',
        'success' 		=> 'Modèle d\'article restauré correctement.'
    ),
